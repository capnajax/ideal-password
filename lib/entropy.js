...
const	ENTROPY_CLASSES = [
  ...
  { score: Math.log(12), desc: "special", range: [0x21, 0x2f, 0x3a, 0x3f, 0x5b, 0x60]},
  ...
  { score: Math.log(500), desc: "hangul",
...
const ENTROPY_CLASS_ALIASES = {
  western: ['lower-roman', 'upper-roman', 'number', 'special']
}
...
function passwordEntropy(_password) {
  ...
  result.legal = !hasIllegalCharacter;
